...
public class ProductBacklogServiceTest {
  ...
  public void getBacklog_whenLimitOffsetSpecified_thenApplyAsIs() {
    ...
    doReturn(list)
        .when(productBacklogItemRepository).find(100, 200);

    assertThat(productBacklogService.getBacklog(100, 200))
  ...
  public void getBacklog_whenLimitIsNull_thenApplyDefault() {
    ...
    doReturn(Collections.singletonList(expected))
        .when(productBacklogItemRepository).find(limitDefault, 5);

    assertThat(productBacklogService.getBacklog(null, 5))
        .contains(expected, atIndex(0));
  }
  ...
  public void getBacklog_whenOffsetIsNull_thenApplyZero() {
    ...
    doReturn(Collections.singletonList(expected))
        .when(productBacklogItemRepository).find(10, 0);

    assertThat(productBacklogService.getBacklog(10, null))
        .contains(expected, atIndex(0));
  }
